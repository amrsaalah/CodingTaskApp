 ...
 */
public class NewAppWidgetConfigureActivity extends Activity implements IWidget.view {
    private static final String TAG = "NewAppWidgetConfigureAc";

    @Inject
    WidgetPresenter presenter;

    private static final String PREFS_NAME = "com.salah.amr.codingtaskapp.widget.NewAppWidget";
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            Log.d(TAG, "onClick: "+presenter);
            presenter.getCurrentTemp(widgetText);
    ...
    static String loadTemp(Context context){
        WeatherSharedPreferences preferences = new WeatherSharedPreferences(context);
        return preferences.getWidgetTemp();
    }
    ...
    public void onCreate(Bundle icicle) {
        ...
        MyApp.getComponent().newWidgetComponent(new WidgetModule(this)).inject(this);
